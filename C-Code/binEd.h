...
inline void scalar_mult_fixed_base(unsigned char op[32], unsigned char n[32], gfe1x baseP[4]);
...
void scalar_mult_fixed_base(unsigned char op[32], unsigned char n[32], gfe1x baseP[4]){
